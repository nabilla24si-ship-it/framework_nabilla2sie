...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <img src="{{ asset('assets/images/logo.png') }}" alt="Logo" style="width:40px; height:auto; margin-right:10px;">
    ...
    <section class="hero-section">
        <div class="container d-flex flex-column align-items-center text-center">
            <div class="d-flex align-items-center justify-content-center">
                <img src="{{ asset('assets/images/logo.png') }}" alt="Logo" class="hero-logo">
                <h1>{{ $username }}</h1>
            </div>
            <p class="mt-2">{{ $last_login }}</p>
        </div>
    </section>
            ...
            <div class="col-md-6">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Our application provides a clean and intuitive interface, allowing users to navigate easily and perform tasks efficiently. Built with Laravel and Bootstrap, it offers flexibility and responsiveness.
                        </p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted small mb-0">
                            Tambahkan <code>.table-striped</code> atau <code>.table-bordered</code> sesuai kebutuhan.
                        </p>
                    </div>
                </div>
            </div>
